...
namespace address_book
{
        ...
        */
        ...
        static void Main(string[] args)
        {
            ...
            foreach (string email in emails)
            {
                ...
                {
                    Console.WriteLine("----------------------------");
                    Console.WriteLine($"There is not a contact with the email {email} in your address book!");
                }
            }
        }
    }
    ...
    public class AddressBook
    {
        ...
        public void AddContact(Contact contact)
        {
            ...
            {
                Console.WriteLine($"There is already a contact with the email {contact.Email} in your address book!");
            }
        }
